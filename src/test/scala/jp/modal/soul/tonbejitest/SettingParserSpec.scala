...
import jp.modal.soul.tonbeji.{ SettingFormatException, FileParser }
...
class SettingParserSpec extends FlatSpec with Matchers {
  object SettingParserImpl extends FileParser {
  ...
  val illegalSettingFile = new File("./src/test/resources/ng/posts/2015-01-16-illegal-setting-format.md")
